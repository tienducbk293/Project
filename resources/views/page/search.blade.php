                ...
                <div class="row justify-content-center d-flex">
                        ...
                        <div class="post-lists search-list">
                            <div class="single-list flex-row d-flex">
                                <div class="thumb">
                                    ...
                                    <img src="source/assets/img/asset/l1.jpg" alt="">
                                </div>
                                <div class="detail">
                            ...
                            <div class="single-list flex-row d-flex">
                                <div class="thumb">
                                    ...
                                    <img src="source/assets/img/asset/l2.jpg" alt="">
                                </div>
                                <div class="detail">
                                    <a href="#"><h4 class="pb-20">Addiction When Gambling <br>
                                    Becomes A Problem</h4></a>
                            ...
                            <div class="single-list flex-row d-flex">
                                <div class="thumb">
                                    ...
                                    <img src="source/assets/img/asset/l3.jpg" alt="">
                                </div>
                                <div class="detail">
                                    <a href="#"><h4 class="pb-20">Addiction When Gambling <br>
                                    Becomes A Problem</h4></a>
                            ...
                            <div class="single-list flex-row d-flex">
                                <div class="thumb">
                                    ...
                                    <img src="source/assets/img/asset/l4.jpg" alt="">
                                </div>
                                <div class="detail">
                                    <a href="#"><h4 class="pb-20">Addiction When Gambling <br>
                                    Becomes A Problem</h4></a>
                    ...
                    <div class="col-lg-4 sidebar-area">
                        ...
                        <div class="single_widget about_widget">
                            <img src="source/assets/img/asset/s-img.jpg" alt="">
                        ...
                        <div class="single_widget recent_widget">
                            ...
                            <div class="active-recent-carusel">
                                ...
                                <div class="item">
                                    <img src="source/assets/img/asset/slider.jpg" alt="">
                                    <p class="mt-20 title text-uppercase">Home Audio Recording <br>
                                    For Everyone</p>
                                    <p>02 Hours ago <span> <i class="fa fa-heart-o" aria-hidden="true"></i>
                                    06 <i class="fa fa-comment-o" aria-hidden="true"></i>02</span></p>    
